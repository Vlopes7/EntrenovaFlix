...
## 📃 Desafio
<a id="desafio"></a>
Desenvolver um dashboard completo e intuitivo que permita aos gestores de RH acompanharem o progresso dos colaboradores nas trilhas de aprendizagem. O painel deve exibir o status das trilhas, indicadores de engajamento individual e coletivo, métricas que facilitem a tomada de decisão e a gestão do desenvolvimento da equipe. O objetivo é oferecer uma visão estratégica e centralizada do desempenho dos colaboradores, contribuindo para uma gestão mais eficiente e orientada por dados.
