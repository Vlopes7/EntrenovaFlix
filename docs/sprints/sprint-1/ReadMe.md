...
## 📃 Desafio
<a id="desafio"></a>
Desenvolver uma landing page interativa que permita às empresas realizarem um diagnóstico completo das suas principais dores organizacionais. A partir desse diagnóstico, será gerada automaticamente uma trilha de conteúdos personalizados com base na base de dados da Entrenova. Além disso, a plataforma deve permitir o login dos colaboradores da empresa contratante, dando acesso a trilhas de conteúdo personalizadas, um fórum de discussão para interação entre os usuários e um dashboard com estatísticas de uso da plataforma.
...
| Critério | Descrição |
| -------- | --------- |
| Testes planejados | Os testes necessários foram definidos. |
| Dependências resolvidas | Todas as dependências externas foram identificadas e resolvidas. |
| Time alinhado | O time compreende completamente as entregas esperadas. |
| Estimativa definida | A User Story foi priorizada e estimada no backlog. |
...
| Critério | Descrição |
| -------- | --------- |
| Tarefa entregue dentro do prazo | A User Story foi concluída dentro do tempo estimado. |
| Funcionalidade implementada | Todos os requisitos foram desenvolvidos conforme especificado. |
| Código revisado | O código foi revisado por pelo menos um membro da equipe. |
| Testes realizados | Os testes necessários foram realizados. |
